...
// initLogging initializes logging system and returns log entry, multi writer and all logs
func initLogging() (*LogEntry, *MultiWriter, []LogEntry) {
	allLogs := loadLogs()
	logData := &LogEntry{
	...
	return logData, capture, allLogs
}

// finalizeLogging finalizes logging and saves logs to file
func finalizeLogging(logData *LogEntry, allLogs []LogEntry) {

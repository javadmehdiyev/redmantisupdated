...
// GetInterfaces returns a list of all active non-loopback network interfaces with IPv4 addresses
func GetInterfaces() ([]NetworkInfo, error) {
...
// GetPrimary tries to determine the primary network interface
// It uses heuristics like preferring en0/eth0/wlan0 and non-virtual interfaces
func GetPrimary(interfaces []NetworkInfo) NetworkInfo {
	if len(interfaces) == 0 {
		return NetworkInfo{}
	}
...
// PrintInterfaces gets and prints all network interfaces
